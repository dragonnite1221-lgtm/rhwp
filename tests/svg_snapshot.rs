...
//! Hancom Office, and pyhwpx and cannot run in CI. This harness invokes
//! `rhwp::wasm_api::HwpDocument::render_page_svg_native()` directly so the same
//! SVG the CLI produces is diffed against committed golden files.
//!
//! # Updating goldens
//!
